!function(t, i) {
    ...
    e.special.smartresize = {
        ...
        layout: function(t, i) {
            ...
            for (s = 0, e = this.styleQueue.length; e > s; s++)
        ...
        _placeBrick: function(t) {
            var s,
                ...
                h,
                a = i(t);
            if (s = Math.ceil(a.outerWidth(!0) / this.columnWidth), s = Math.min(s, this.cols), 1 === s)
                n = this.colYs;
            else
                for (e = this.cols + 1 - s, n = [], h = 0; e > h; h++)
